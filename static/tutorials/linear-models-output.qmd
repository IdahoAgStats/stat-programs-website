...
- `drop1()` and `add1()` drop/add terms sequentially and evaluate model fit statistics (not applicable for simple linear regression)
...
$$ \hat{Y}_{ijk} = \beta_0 + \beta_1N +\beta_2P + \beta_3K $$
...
$$ \hat{Y}_{npk} = \beta_0 +...+ \beta_4 Bl2 + \beta_5 Bl3 + \beta_6 Bl4 + \beta_7 Bl5 + \beta_8 Bl6$$
